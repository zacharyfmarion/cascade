...
- **Engine bridge**: `EngineBridge` interface abstracts over worker-backed WASM, direct WASM, and Tauri IPC backends. Direct WASM wraps wasm-bindgen calls behind async-safe frontend methods where needed; Tauri is async IPC.
