...
export const CASCADE_EXAMPLES: CascadeExample[] = [
  ...
  {
    id: 'batch-resize-export',
    title: 'Batch Resize Export',
    section: 'Getting Started',
    description: 'Resize a set of images to fit within a delivery box, then export the processed batch.',
    tags: ['Batch', 'Resize', 'Export'],
    projectUrl: publicAsset('examples/batch-resize-export.casc'),
    thumbnailUrl: publicAsset('examples/thumbs/batch-resize-export.webp'),
    requiredNodeTypes: ['load_image_batch', 'resize', 'viewer', 'export_image_batch'],
  },
  {
    id: 'watermark-overlay',
    title: 'Watermark Overlay',
    section: 'Getting Started',
    description: 'Place a bundled logo over a photo with root-graph math for scale and margin.',
    tags: ['Composite', 'Watermark', 'Layout'],
    projectUrl: publicAsset('examples/watermark-overlay.casc'),
    thumbnailUrl: publicAsset('examples/thumbs/watermark-overlay.webp'),
    requiredNodeTypes: ['load_image', 'image_info', 'math', 'resize', 'translate', 'gpu_kernel::alpha_over', 'viewer', 'export_image'],
  },
  {
