...
describe('static SEO surface', () => {
  it('ships a production-ready head in index.html', () => {
    ...
    expect(html).toContain('<title>Cascade — Free node-based image editor for the browser</title>');
    ...
    expect(html).toContain('<h1>Node-based image editing, free in your browser.</h1>');
  ...
  it('ships correctly sized manifest icons', () => {
