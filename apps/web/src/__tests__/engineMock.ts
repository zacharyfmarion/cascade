...
const NODE_SPECS: NodeSpec[] = [
  ...
  },
  {
    ...
    inputs: [
      { name: 'a', label: 'A', ty: 'Float', default: { Float: 0 }, step: 0.01, ui_hint: { type: 'NumberInput' } },
      { name: 'b', label: 'B', ty: 'Float', default: { Float: 0 }, step: 0.01, ui_hint: { type: 'NumberInput' } },
    ],
    outputs: [{ name: 'value', label: 'Value', ty: 'Float' }],
    params: [
      {
  ...
  {
    id: 'export_image_sequence',
    display_name: 'Export Image Sequence',
    category: 'Output',
    description: 'Export an image sequence',
    inputs: [{ name: 'image', label: 'Image', ty: 'Image' }],
    outputs: [{ name: 'display', label: 'Display', ty: 'Image' }],
    params: [
      {
